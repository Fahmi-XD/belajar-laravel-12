...
<body class="dark:bg-gray-800">
    <div class="min-h-full">
        <nav class="bg-gray-800" x-data="{ active: false }">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-4 flex items-center md:ml-6">
                            ...
                            <div class="relative ml-3">
                                <div>
                                    <button type="button" x-on:click="active = !active"
            ...
            <div class="md:hidden" id="mobile-menu">
                ...
                <div class="border-t border-gray-700 pt-4 pb-3">
                    <div class="flex items-center px-5">
                        <div class="shrink-0" x-on:click="active = !active">
                    ...
                    <div class="mt-3 space-y-1 px-2">
                        ...
                        <a href="#"
                            ...
                            out</a>
                        <a href="#"
                            class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white">-</a>
                    </div>
                </div>
            </div>
        </nav>
        ...
        <main>
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <div class="relative overflow-x-auto">
                    <table
                        class="w-full border border-white text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            @foreach ($products as $product)
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                                    ...
                                    <td class="px-6 py-4">
                                        <button x-data x-on:click="hapus({{ $product->id }})"
                                            class="px-5 py-2 cursor-pointer hover:opacity-70 bg-red-500 rounded-[10px] outline-none text-white">Delete</button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
